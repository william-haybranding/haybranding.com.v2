      ...
      content: (
        <div className="flex w-full overflow-hidden relative h-full rounded-3xl p-10 bg-gradient-to-br from-orange-500 to-orange-600">
          <Link href="/services/branding" legacyBehavior>
            <a className="relative w-full flex items-end content-between flex-wrap h-full">
              ...
              <div className="w-full md:w-2/6">
                ...
                <p className="text-white text-md mt-2 pb-10">
              ...
              <div className="w-full md:w-3/6 md:pl-10 h-56 md:h-full">
            ...
            <a className="relative w-full flex items-end content-between flex-wrap h-full">
              ...
              <div className="w-full md:w-2/6">
                ...
                <p className="text-white text-md mt-2">
                  ...
                  presence and effectively reach your target audience through
